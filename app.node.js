  ...
  function Navigation() {
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'a',
          { className: 'Navigation-link', href: 'https://github.com/marmelroy' },
          'GitHub'
        )
      ),
      _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'a',
          { className: 'Navigation-link', href: 'http://instagram.com/marmelroy' },
          'Instagram'
        )
      )
    );
    ...
    _createClass(_default, [{
      ...
      value: function render() {
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement('br', null),
          _react2['default'].createElement('br', null),
          _react2['default'].createElement(_reactRetinaImage2['default'], { src: 'thumbsUp.png', alt: 'Emoji of the Month' }),
          _react2['default'].createElement('br', null),
          _react2['default'].createElement('br', null)
        );
      }
